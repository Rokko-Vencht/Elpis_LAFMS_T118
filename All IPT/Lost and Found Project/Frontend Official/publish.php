...
<head>
    ...
    <title>FoundIt: My Publishes</title>
    ...
    <style>
        ...
        /* Modal margin styles specific to publish.php */
        ...
        form#update-lost-form,
        form#update-found-form {
            position: relative;
            height: 100%;
            display: flex;
...
<body>
    <div id="pge-cont">
        <div id="topbar">
            ...
            <div class="srch-cont">
                <form action="publish.php" method="GET" class="srch-grp">
        ...
        <div id="bttm-cont">
            ...
            <?php if (isset($_SESSION['success'])): ?>
                ...
                <div class="main-cont-header">
                    ...
                    <p>View and edit the information of your published items.</p>
                </div>
                ...
                <div class="lf-items-container">
                    ...
                    $sql = "SELECT t.*, 
                           ...
                           WHERE t.transaction_status != 'Resolved' /**ONLY SHOW THOSE UNRESOLVED TRANSACTIONS */
                           AND t.pub_id = '{$_SESSION['user_id']}' /**ONLY SHOW ITEMS PUBLISHED BY CURRENT USER */
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            <div class="lf-item-card" data-transaction-id="<?php echo htmlspecialchars($row['transaction_id']); ?>">
                                ...
                                <button class="lf-edit-details-btn <?php echo $modalClass; ?>" 
            ...
            <!-- PRESENT EDITING MODALS HERE AGAIN -->
            ...
            <div class="lf-modal-container" id="lf-modal-container">
                <div class="lf-modal"> 
                    ...
                    <form id="update-lost-form" method="POST">
                    ...
                    <div id="lf-info-control">
                        ...
                        <div class="lf-info-details">
                            ...
                            <div id="lf-form-group">
                                ...
                                <input type="text" id="edit-item-name" name="edit-item-name" maxlength="30" class="lf-item-name-input" required>
                            </div>
                            <div id="lf-form-group">
                                <p id="lf-item-holder-title">Category:</p>
                                <select name="edit-item-category" id="edit-item-category" required>
                            ...
                            <div id="lf-form-group">
                                ...
                                <select name="edit-location-last-seen" id="edit-location-last-seen">
                    ...
                    <div id="lf-form-group-desc" class="lf-desc-box">
                        ...
                        <textarea id="edit-item-details" class="lf-item-details-textarea" rows="4"></textarea>
                            </div>
                    </div>

                        <div class="button-container">
                            <button type="submit" id="lf-save-changes" class="lf-btn lf-save-btn">Save Changes</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="lf-modal-container-f" id="lf-modal-container-f">
                <div class="lf-modal"> 
                    ...
                    <form id="update-found-form" method="POST">
                        <div class="form-content">
                    <div id="lf-info-control">
                        <div id="lf-photo-cont">
                            <img id="lf-item-holder-img" src="" alt="">
                        ...
                        <div class="lf-info-details">
                            ...
                            <div id="lf-form-group">
                                <p id="lf-item-holder-title">Item Name:</p>
                                <input type="text" id="edit-item-name-found" name="edit-item-name" maxlength="30" class="lf-item-name-input" required>
                            </div>
                            <div id="lf-form-group">
                                <p id="lf-item-holder-title">Category:</p>
                                <select name="edit-item-category" id="edit-item-category-found" required>
                                    <option value="" disabled selected>Select Category</option>
                                    <option value="CAT001">Electronics</option>
                                    <option value="CAT002">Sports/Recreation</option>
                                    <option value="CAT003">Documents</option>
                            ...
                            <div id="lf-form-group">
                                ...
                                <select name="edit-location-found" id="edit-location-found">
                                    <option value="" disabled selected>Select Location</option>
                                    <option value="LF00-0001">ESL</option>
                                    <option value="LF00-0002">Library</option>
                                    <option value="LF00-0003">Canteen</option>
                            ...
                            <div id="lf-form-group">
                                ...
                                <select name="edit-location-stored" id="edit-location-stored-found">
                                    <option value="" disabled selected>Select Location</option>
                    ...
                    <div id="lf-form-group-desc" class="lf-desc-box">
                        <div class="lf-desc-label">Description:</div>
                        <textarea id="edit-item-details-found" class="lf-item-details-textarea" rows="4"></textarea>
                            </div>
                    </div>
